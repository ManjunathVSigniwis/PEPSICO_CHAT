		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PEPSI CO",
									"targetURL": "#sappepsicopepsico1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sappepsicopepsico1-display": {
								"semanticObject": "sappepsicopepsico1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.pepsi.co.pepsico1",
									"url": sap.ui.require.toUrl("sap/pepsi/co/pepsico1")
								}
							}
						}
					}
